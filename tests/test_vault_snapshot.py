...
# ---------------------------------------------------------------------------
# NOTE: TestRefreshCallbackTickerCollection was removed — it tested
# routers.telegram_bot._handle_vault_refresh_callback which was deleted
# as part of the Telegram feature removal.
# ---------------------------------------------------------------------------
